...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Muhammad Asim Saqlain — AI Automation Engineer" },
      { name: "description", content: "AI Automation Engineer | AI Agents, n8n, RAG, LLM Integration, FastAPI backends." },
      { name: "author", content: "Muhammad Asim Saqlain" },
      { property: "og:title", content: "Muhammad Asim Saqlain — AI Automation Engineer" },
      { property: "og:description", content: "AI Automation Engineer | AI Agents, n8n, RAG, LLM Integration, FastAPI backends." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Muhammad Asim Saqlain — AI Automation Engineer" },
